...
const Nosotros = () => {
  return (
    <section
      ...
      <h1 className="capitalize text-black font-bold text-5xl pb-10 md:text-6xl lg:text-7xl text-center italic ">
        ANKARA
        <span className="ml-4 text-black text-4xl lg:text-5xl italic ">
          es...
        </span>
      </h1>
