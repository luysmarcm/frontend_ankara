				...
				<div className="pb-10 flex flex-col items-center space-y-5">
					<div className="flex space-x-4 justify-center ">
						<div className="flex flex-col justify-center justify-items-center">
							<div className="relative z-20 text-4xl lg:text-6xl text-center font-pshoot text-opacity-80 text-gray-200 ">
								Identidades
					...
					<p className="text-black pt-5 text-lg md:text-xl lg:text-1xl text-center max-w-3xl lg:pt-24">
