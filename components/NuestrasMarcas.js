...
const NuestrasMarcas = () => {
    return (
			...
			>
				...
				<div className="grid grid-cols-2 lg:grid-cols-4 gap-10 mx-auto h-full pb-12 place-content-around pt-32">
					{amelow.map((i, index) => (
						<Image
							src={i.imagen}
							alt="Amelow"
							...
							height={640}
							// layout="responsive"
							className="block object-center w-2/5"
						/>
					))}
				</div>
				<div className="pb-10 flex flex-col items-center space-y-5">
					...
					<p className="text-black text-lg md:text-xl lg:text-1xl text-center max-w-3xl">
						...
						de esmaltes para uñas, y todo lo que necesitas para lucir una
						manicura y pedicura llena de glamour.
					</p>
				</div>
