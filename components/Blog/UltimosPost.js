    ...
    <>
      ...
      <div className="flex flex-col">
        {posts.map(function (post, i) {
          return (
            <div className="h-28">
              <Link key={i} href={`/blog/${post.attributes.slug}`}>
                <a className=" text-black font-light text-lg flex flex-row gap-x-3">
                  <Image
                  ...
                  <div className="text-black self-end">
                    <p className="text-lg font-bold">{post.attributes.titulo}</p>
